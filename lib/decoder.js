  ...
  function tryDecode (buf, offset) {
    ...
    switch (first) {
      ...
      case 0xd9:
        ...
        result = buf.toString('binary', offset + 2, offset + 2 + length)
      ...
      case 0xda:
        ...
        result = buf.toString('binary', offset + 3, offset + 3 + length)
      ...
      case 0xdb:
        ...
        result = buf.toString('binary', offset + 5, offset + 5 + length)
